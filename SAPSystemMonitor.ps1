...
.VERSION
    1.2 - Most reliable destination creation method
#>
...
function Get-SapDestination {
    ...
    # Create destination directly (most reliable method in NCo 3.1)
...
# ==================== TABLE READER ====================
function Read-Table {
    param($Destination, [string]$TableName, [int]$MaxRows = 30)
...
$jobs = Read-Table -Destination $dest -TableName "TBTCO" -MaxRows 20
